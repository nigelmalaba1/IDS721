...
def weekend(day):
    ...
    #if(day == "Sunday"):
       #return "Let's nourish up with some fruits before the start of the week. Here are some options for you:\n" + fruits[1] + " " + fruits[2] + " " + fruits[3] + " " + fruits[4] + " " + fruits[5] + " " + fruits[6]    
